...
\frac{\partial Z}{\partial x_i} &= \text{Tr} \left[ U^{-1} U' \right]
\frac{\partial^2 Z}{\partial x_i \partial x_j} &= \text{Tr} \left[ \frac{\partial U^{-1}}{\partial} U' + U^{-1} \frac{\partial U'}{\partial x_j} \right]
\end{align}
\]
</div>
